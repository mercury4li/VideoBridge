...
<p align="center">
  <img src="./web/default/public/logo.svg" width="150" height="150" alt="framebridge api logo">
</p>
...
_基于 One API 二次开发的视频生成 API 中转站原型_
...
帧桥 API 是基于 One API fork 的视频生成 API 中转站原型。二开、本地启动、开发测试和部署流程请看：[帧桥 API 二开指南](./docs/framebridge-development-guide.md)。
